...
/* ═══════════════════════════════════════════════════════════════
   DeGoogler v0.1.0 — Interactive Google Services Migration Wizard
   ═══════════════════════════════════════════════════════════════ */
      ...
      <div style={styles.container}>
        ...
        <div style={{ textAlign: "center", padding: "32px 0", borderTop: `1px solid ${C.border}`, marginTop: 32 }}>
          <p style={{ fontSize: 11, color: C.textDim }}>
            DeGoogler v0.1.0 — Your data never leaves your browser. Open source. No tracking.
          </p>
        </div>
      </div>
    </div>
